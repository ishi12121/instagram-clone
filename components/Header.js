  ...
  return (
    <div className="flex items-center justify-between max-w-6xl mx-4 xl:mx-auto">
      ...
      <div className="flex space-x-4 items-center">
        ...
        <img src="https://avatars.githubusercontent.com/u/106435172?s=400&u=f323a33976f23fcb94e37bf573af2bf81444f7f8&v=4" alt="user-image" className="h-10 rounded-full cursor-pointer"/>
      </div>
    </div>
  );
}